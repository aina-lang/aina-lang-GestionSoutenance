            ...
            <div class="w-full">
                <div class="mb-4 w-full">
                    ...
                    <input type="text" id="matricule" name="design"
                        class="w-full px-3 py-2 border rounded-md outline-none focus:ring-2 focus:ring-blue-500" value="{{ $organisme->design }}"
                        required>
                </div>
                <div class="mb-4">
                    <label for="lieu" class="block text-gray-700 font-bold mb-2">Lieu</label>
                    <input type="text" id="lieu" name="nom"
                        class="w-full px-3 py-2 border rounded-md outline-none focus:ring-2 focus:ring-blue-500" value="{{ $organisme->lieu }}"
                        required>
                </div>
            </div>
        </div>
