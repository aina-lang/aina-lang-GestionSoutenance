            ...
            <form class=" mb-9 xl:w-3/6 xl:float-right" >
                ...
                <div class="flex">
                    ...
                    <div class="relative w-full">
                        ...
                        <a href="{{ route('etudiant.recherche') }}"
    ...
    $('#search-btn').click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#etudiant-table tbody').html(data);
            },
                ...
                @foreach ($etudiants as $etudiant)
                    <tr class="bg-white dark:bg-gray-800 default-data">
                        ...
                        <td class=" py-4 flex">
                            ...
                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline px-5 py-2.5 mr-2 mb-2">Edit</a>

                            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                                class=" text-red-600 hover:text-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 text-center"
                                type="button">
                                Supprimer
                            </button>
                            <a href="{{ route('etudiant.pdf') }}"
                            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Proces verbal</a>
