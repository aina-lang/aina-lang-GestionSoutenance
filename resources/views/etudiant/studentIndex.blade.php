<x-app-layout>
    ...
    <div class="overflow-x-auto  sm:ml-64 mb-10">
        ...
        <div class="xl:flex justify-between">
            ...
            <form class=" mb-9 xl:w-3/6 xl:float-right" action="{{ route('etudiant.recherche') }}">
    ...
    $('#search-btn').click(function() {
        ...
        <div class="button-action mt-10 flex justify-end">
            ...
            <a href="{{ route('etudiant.pdf') }}"
                class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Green</a>
