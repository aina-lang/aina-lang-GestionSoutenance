<x-app-layout>
    ...
    <div class=" px-4 sm:ml-64 mb-10 ">
        ...
        <div class="mb-5">
            <form action="{{ route('etudiant.note') }}" method="GET" class="flex flex-row">
                @csrf
                @method('GET')
                <div class="flex flex-row space-x-2">
                    <label for="annee_debut" class="font-medium text-gray-900 w-30">Année de début :</label>
                    <input type="text" name="annee_debut" id="start_year" required class="w-20 h-8 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 p-2 text-sm">
                    <label for="annee_fin" class="font-medium text-gray-900">Année de fin :</label>
                    ...
                    <tr class="bg-white dark:bg-gray-800 default-data">
                        ...
                        <td class=" py-4 flex tracking-wide">
                            ...
                            <button data-modal-target="editEtudiantModal{{ $i }}"
                                ...
                                class=" hover:rotate-45 text-blue-600 hover:text-blue-700 focus:ring-4 focus:outline-none open-modal focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 text-center"
                                type="button">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400 test">
                                                Vous êtes sûre d'effacer l' etudiant {{ $etudiant->matricule }}?
                                            </h3>
                ...
                <div class="bg-white p-4 rounded-lg shadow overflow-hidden flex">
                    ...
                    <div class="flex flex-col w-1/12 h-full text-right">
                        ...
                        <div id="readEtudiantModale{{ $i }}" tabindex="-1" aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed  right-0 left-0 top-14 z-50  justify-center items-center transition-all">
                            <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
                                <!-- Modal content -->
                                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                    <!-- Modal header -->
                        ...
                        <div id="popup-modale{{ $i }}" tabindex="-1"
                            class="fixed  left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto top-14">
                            <div class="relative w-full h-full max-w-md md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <button type="button"
                                        class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
